...
module.exports = {
  ...
  'ITEM_PROPERTY_CONDITION_IMMUNITY': require('./condition-immunity.js'),
  ...
  'ITEM_PROPERTY_ONHIT_APPLY_EFFECT_GROUP': require('./onhit-apply-effect-group.js'),
